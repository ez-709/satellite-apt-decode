...
from storage import json_to_py, read_config, add_rtl_sdr_libs_to_venv, clear_all_logs, create_decode_folders_by_names, create_sat_record_sructure
...
try:
    ...
    while True:
        try:
            ...
            error_message = f'{error_time} - Ошибка в работе записи ({file_name}, строка {line_number}): {str(e)}\n'
